...
public class AboutDao {
    ...
    public void insert(String date, Map<String, Object> data) {
        var sql = "INSERT INTO about(jmdict_date, nb_entries, languages) VALUES (:jmdict_date, :nb_entries, :languages);";
