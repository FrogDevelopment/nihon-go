...
public class InputUtils {
    ...
    public static boolean isOnlyJapanese(final String input) {
    ...
    public static boolean containsJapanese(final String input) {
    ...
    public static boolean containsNoJapanese(final String input) {
        return !containsJapanese(input);
    }

    public static boolean containsKanji(final String input) {
